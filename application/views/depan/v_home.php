        ...
        <div id="carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="carousel-item active">
                    <img class="d-block" src="<?php echo base_url().'theme/images/banner-ketiga.jpg'?>" alt="First slide" style="filter: brightness(50%); height: 650px;">
                    <div class="carousel-caption d-md-block">
                        <div class="slider_title">
                        <h1>Camping Dengan View Gunung Kapur Cileungsi</h1>
                            <h4>Villa Bukit Hambalang.
                            <br>Promo One Day Camping Bogor</h4>
                            <h4>Rp. 200.000 / pax / malam</h4>
                ...
                <div class="carousel-item">
                    <img class="d-block" src="<?php echo base_url().'theme/images/banner-kedua.jpg'?>" alt="Second slide" style="filter: brightness(50%); height: 650px;">
                    <div class="carousel-caption d-md-block">
                        <div class="slider_title">
                            <h1>Villa Sejuk Dengan Panorama Hutan Pinus</h1>
                            <h4>Villa Bukit Hambalang.
                ...
                <div class="carousel-item">
                    <img class="d-block" src="<?php echo base_url().'theme/images/banner-pertama.jpeg'?>" alt="Third slide" style="filter: brightness(50%); height: 650px;">
                    <div class="carousel-caption d-md-block">
                        <div class="slider_title">
                            <h1>View Menarik Dengan Panorama Pegunungan</h1>
