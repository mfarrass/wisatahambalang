                ...
                <div class="col-md-12">
                    <div class="single-item">
                        <div class="quote">
                            ...
                            <p class="quote_text">Tempat Wisata di Hambalang, tempatnya sejuk pemandangan indah, terus juga untuk harga makan dan minum dihambalang cukup murah. Thank you pas banget  untuk kantong mahasiswa</p>
                            <div class="testi-img_block">
                                <img src="<?php echo base_url().'theme/images/foto2.jpeg'?>" class="img-fluid" alt="#">
                                <p><span>Jonathan Aditya</span>Wisatawan</p>
                            </div>
                        </div>
                        <div class="quote">
                            <i class="fa fa-quote-left" aria-hidden="true"></i>
                            <p class="quote_text">Hangout di Cafe 129 Hambalang mantab. tempat yang pas untuk kumpul bersama teman teman dan keluarga. Service yang di tawarkan pun, sesuai dengan yang kita keluarkan. God Bless Cafe 129 Hambalang </p>
                            <div class="testi-img_block">
                                <img src="<?php echo base_url().'theme/images/foto3.jpg'?>" class="img-fluid" alt="#">
                                <p><span>Dhiyas Sayyida</span>Wisatawan</p>
                            </div>
                        </div>
                    </div>
                </div>
